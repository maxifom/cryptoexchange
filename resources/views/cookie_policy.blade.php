...
@section ('content')
    <div class="container">
        <h1>Cookie Policy for theBro</h1>

        <p>This is the Cookie Policy for theBro, accessible from https://thebro.exchange</p>
        ...
        <ul>
            ...
            <li>By visiting this link: https://thebro.exchange/createTicket</li>
        </ul>
    </div>
@endsection