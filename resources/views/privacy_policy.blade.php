...
@section ('content')
    <div class="container">
        ...
        <p>Effective date: September 05, 2018</p>


        <p>theBro ("us", "we", or "our") operates the https://thebro.exchange website (the "Service").</p>
        ...
        <p>theBro uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>If you are located outside Germany and choose to provide information to us, please note that we transfer the
            data, including Personal Data, to Germany and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
            to that transfer.</p>
        <p>theBro will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <p>theBro may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of theBro</li>
        ...
        <ul>
            <li>By visiting this page on our website: https://thebro.exchange/createTicket</li>
