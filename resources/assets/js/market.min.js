        ...
        if (this.notification_enabled && this.user_id!=null) {
            ...
            Echo.private('trades.' + this.user_id)
                .listen('.NewUserTrade', (e) => {
                    ...
                    if (e.data.trade.type == 'sell') {
                        this.wallet_base.balance = Decimal(this.wallet_base.balance).sub(Decimal(e.data.trade.amount).mul(Decimal(e.data.trade.price)).mul(1.002)).toFixed(8).toString();
                        ...
                        this.wallet_base.balance = Decimal(this.wallet_base.balance).add(Decimal(e.data.trade.amount).mul(Decimal(e.data.trade.price)).mul(0.998)).toFixed(8).toString();
                    }
                })
                .listen('.TradeDeleted', (e) => {
                    ...
                    if (e.data.trade.type == 'sell') {
                        ...
                        this.wallet_base.balance = Decimal(this.wallet_base.balance).add(Decimal(e.data.trade.amount).mul(Decimal(e.data.trade.price)).mul(1.002)).toFixed(8).toString();
                    }
                })
                .listen('.NewTrade', (e) => {
                    //console.log('new');
    ...
    methods: {
        ...
        buy_total: function () {
            if (this.$refs.buy_total.value > 0)
                this.buy_trade.amount_base = Decimal(this.$refs.buy_total.value / 1.002).toFixed(8);
            if (this.$refs.buy_price.value > 0)
        ...
        sell_total: function () {
            if (this.$refs.sell_total.value > 0)
                this.sell_trade.amount_base = Decimal(this.$refs.sell_total.value / 0.998).toFixed(8);
            if (this.$refs.sell_price.value > 0)
